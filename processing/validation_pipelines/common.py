...
def create_pipeline(metric: str, resolver: Optional[Resolver] = None) -> Pipeline:
    ...
    step = PrimitiveStep(
        primitive_description=DatetimeFieldComposePrimitive.metadata.query(),
        resolver=resolver,
    )
    step.add_argument(
        name="inputs",
    ...
    step = PrimitiveStep(
        primitive_description=DatetimeRangeFilterPrimitive.metadata.query(),
        resolver=resolver,
    )
    step.add_argument(
        name="inputs",
    ...
    step = PrimitiveStep(
        primitive_description=TermFilterPrimitive.metadata.query(), resolver=resolver
    )
    step.add_argument(
        name="inputs",
        argument_type=ArgumentType.CONTAINER,
    ...
    step = PrimitiveStep(
        primitive_description=RegexFilterPrimitive.metadata.query(), resolver=resolver
    )
    step.add_argument(
        name="inputs",
        argument_type=ArgumentType.CONTAINER,
    ...
    step = PrimitiveStep(
        primitive_description=NumericRangeFilterPrimitive.metadata.query(),
        resolver=resolver,
    )
    step.add_argument(
        name="inputs",
