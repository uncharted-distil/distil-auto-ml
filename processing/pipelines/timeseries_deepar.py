...
def create_pipeline(metric: str) -> Pipeline:
    ...
    step = PrimitiveStep(primitive_description=DeepAR.metadata.query())
    step.add_argument(name='inputs', argument_type=ArgumentType.CONTAINER, data_reference=input_val.format(attribute_step))
