...
def create_pipeline(
    ...
    # step 2 - read text
    step = PrimitiveStep(
        primitive_description=TextReaderPrimitive.metadata.query(), resolver=resolver
    )
    step.add_argument(
        name="inputs",
        argument_type=ArgumentType.CONTAINER,
    ...
    step = PrimitiveStep(
        primitive_description=Sent2Vec.metadata.query(), resolver=resolver
    )
    step.add_argument(
        name="inputs",
        argument_type=ArgumentType.CONTAINER,
