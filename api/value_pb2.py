...
_VALUE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='parquet_uri', full_name='Value.parquet_uri', index=7,
...
_VALUE.oneofs_by_name['value'].fields.append(
  _VALUE.fields_by_name['parquet_uri'])
_VALUE.fields_by_name['parquet_uri'].containing_oneof = _VALUE.oneofs_by_name['value']
